                ...
                if len(order_depth.sell_orders) != 0 and len(order_depth.buy_orders) != 0:
                    ...
                    if len(order_depth.buy_orders) != 0:
                        ...
                        while k < len(list(order_depth.buy_orders.items())):
                            ...
                            k += 1
                    if imbal > 50:
                         orders.append(Order(list(product, order_depth.buy_orders.items())[0][0], -order_depth.buy_orders.items())[0][1]))
                    elif imbal < 50:
                         orders.append(Order(list(product, order_depth.sell_orders.items())[0][0], order_depth.sell_orders.items())[0][1]))
