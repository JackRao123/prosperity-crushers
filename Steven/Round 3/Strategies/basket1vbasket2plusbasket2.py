...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        edge_max_retreet = 120    #T HIS is higher than edge_0
        edge_0_retreet = 5
        ...
        edge_0_retreet = 33
        position_max = int(130/4)

        basket_2_position = state.position.get("PICNIC_BASKET2", 0) + state.position.get("PICNIC_BASKET1", 0)
        sell = False
        buy = False
