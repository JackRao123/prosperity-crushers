...
class Log:
    ...
    def get_trade_history_as_df(self) -> pd.DataFrame:
        symbols = []
        prices = []
        quantitys = []
        buyers = []
        ...
        for trade in self.trade_history:
            ...
            quantitys.append(trade.quantity)
            buyers.append(trade.buyer)
            sellers.append(trade.seller)
            timestamps.append(trade.timestamp)
            currencys.append("SEASHELLS")
