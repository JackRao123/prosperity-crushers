class Trader:
    ...
    def run(self, state: TradingState):
        ...
        edge_max_retreet = 100  # T HIS is higher than edge_0
        edge_0_retreet = -20
        ...
        pos_buy = self.size_function(z_mid, edge_0, edge_max, position_max)
        pos_sell = self.exit_size_function(z_mid, edge_0_retreet, edge_max_retreet, position_max)
